        ...
        <div className=" flex  absolute mt-[250px] justify-center w-[100%]">
          <div className=" text-white  text-center ">
            ...
            <div className=" text-white xl:mt-[16px] mt-[8px]" >
              ...
              <Link to={"login"}><button type="submit" className=" justify-center mx-auto mt-[20px] bg-red-600 xl:w-[203px] xl:h-[56px] md:h-[50px] md:w-[160px] sm:h-[45px] sm:w-[120px] h-[40px] w-[90px] xl:text-2xl md:text-xl sm:text-base text-[12px] md:font-semibold font-medium rounded text-left  flex  hover:bg-[rgb(193,17,25)] duration-300"><span className=" md:ml-[12px] md:mt-[10px] sm:ml-[8px] sm:mt-[8px] ml-[6px] mt-[9px]">{lang[selectedLanguage].signupBtn}</span><span className="md:ml-[10px] md:mt-[15px] sm:ml-[8px] sm:mt-[13px] ml-[3px] mt-[12px]"><SlArrowRight className="  xl:w-[24px] xl:h-[22px] md:w-[18px] md:h-[18px] sm:w-[14px] sm:h-[15px] font-extrabold"/></span> </button></Link> 
