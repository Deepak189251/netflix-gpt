        ...
        <div className="  text-white">
          <div className="container-comp1 bg-black w-[100%] h-[538px] pt-[50px] pb-[50px]" >
           <div className="  md:flex sm:flex-row sm:justify-between md:justify-center ">
             ...
             <div className=" xl:w-[525px] lg:w-[420px] md:w-[330px] w-[460px] h-[350px]   md:pl-[10px] lg:bottom-[15px] md:bottom-[8px] bottom-[60px] md:m-0 m-auto  relative text-center ">
              
                <img className= " xl:h-[394px] xl:w-[519px] lg:w-[410px] lg:h-[310px] md:w-[320px]  md:h-[250px] sm:w-[440px] sm:h-[320px] w-[320px] h-[250px] xl:top-[25px] top-[90px] bottom-[19px] z-[1] absolute md:left-0 sm:left-0 xs:left-[65px]" alt="tv" src="https://assets.nflxext.com/ffe/siteui/acquisition/ourStory/fuji/desktop/tv.png" data-uia="nmhp-card-animation-asset-image"/>
